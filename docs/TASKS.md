...
- **Phase:** P1 – First-Person-Spielgefühl.
- **Milestone:** M1 – Bewegung macht den Raum spielbar; Zulauf R1.
- **Status:** GATE_OPEN – 20.09.2026; P1-01 bis P1-03 ACCEPTED, E12a vorläufig bestätigt (siehe „E12a-Beleg“ unten). Es fehlen noch die benötigten E03-Schritttestparameter: Schrittabstand in Metern zurückgelegter Bodenstrecke je Kontext Gehen/Sprint/Ducken, Kontextunterschied in Lautstärke bzw. Tonhöhe, Verhalten bei Landung und bei Traversal. Nach diesem Beleg READY.
