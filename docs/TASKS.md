...
- **Phase:** P1 – First-Person-Spielgefühl.
- **Milestone:** M1 – Bewegung macht den Raum spielbar; Zulauf R1.
- **Status:** READY – 20.09.2026; P1-01/02 ACCEPTED (praktisch geprüft, Junior-Playtests) und E03 um das Traversal-Profil ergänzt (siehe „E03-Nachtrag Traversal“ unten). Kein automatischer Arbeitsbeginn; konkreter Auftrag steht aus.
