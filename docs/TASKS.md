...
- **Phase:** P1 – First-Person-Spielgefühl.
- **Milestone:** M1 – Bewegung macht den Raum spielbar; Zulauf R1.
- **Status:** GATE_OPEN – 20.09.2026; P1-01 bis P1-03 ACCEPTED. Es fehlt der E12a-Beleg (kleine bekannte Testtonquelle, erlaubte Lautstärke, Hörgerät, benötigtes Testimportprofil) sowie die benötigten E03-Schritttestparameter; nach diesem Beleg READY. Die reine Debuganzeige könnte bei offenem Audiogate separat beauftragt werden, Audio bliebe dann offen.
